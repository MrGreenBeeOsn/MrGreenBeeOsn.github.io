    ...
    <article>
      ...
      <div className="vocabulary-container">
        ...
        <details className="sub-box-fix-2 margin-bottom-20">
          ...
          <summary id="luat-basic-practice"><mark className="highlight-secondary-padding-2-4">Quiz</mark></summary>

          <ul className="list-border1">

            <li>
              <div className="li-content">
                <Link to="/luat/trac-nghiem-ve-luat-phap">Trắc nghiệm về Luật pháp</Link>
              </div>
            </li>
