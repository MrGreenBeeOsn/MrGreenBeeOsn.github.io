...
export default function EVJournalEntriesQuiz(): React.JSX.Element {
	...
	const questions: Question[] = [
		{
			...
			options: [
				...
				"Dr Service Revenue $5,000 / Cr Accounts Receivable $5,000",
				"Dr Accounts Payable $5,000 / Cr Service Revenue $5,000"
			],
			correctAnswer: 1,
			explanation: "Khi cung cấp dịch vụ \"on account\" (chưa thu tiền), tài khoản Phải thu khách hàng (Accounts Receivable) tăng lên (ghi Nợ - Debit) và Doanh thu dịch vụ (Service Revenue) tăng lên (ghi Có - Credit)."
		},
		{
			id: 2,
			...
			options: [
				...
				"Dr Utility Expense $200 / Cr Accounts Payable $200",
				"Dr Accounts Payable $200 / Cr Utility Expense $200"
			],
			correctAnswer: 2,
			explanation: "Chi phí phát sinh nhưng chưa trả tiền được ghi nhận vào chi phí (Utility Expense - Nợ) và nợ phải trả (Accounts Payable - Có)."
		},
		{
			id: 3,
			...
			options: [
				...
				"Dr Accounts Receivable $10,000 / Cr Owner's Capital $10,000"
			],
			correctAnswer: 0,
			explanation: "Khi chủ sở hữu góp vốn, tài sản tiền mặt của công ty tăng (Nợ Cash) và Vốn chủ sở hữu tăng (Có Owner's Capital)."
		},
		{
			id: 4,
			...
			options: [
				...
				"Dr Cash $3,000 / Cr Prepaid Rent $3,000",
				"Dr Prepaid Rent $3,000 / Cr Rent Payable $3,000"
			],
			correctAnswer: 1,
			explanation: "Đây là chi phí trả trước (Prepaid Expense), một loại tài sản. Khi trả tiền, ghi tăng tài sản (Prepaid Rent - Nợ) và giảm tiền mặt (Cash - Có)."
		},
		{
			id: 5,
			...
			options: [
				...
				"Dr Office Supplies $500 / Cr Accounts Payable $500",
				"Dr Accounts Payable $500 / Cr Office Supplies $500"
			],
			correctAnswer: 2,
			explanation: "Mua vật dụng văn phòng bằng hình thức ghi nợ (on credit), tài khoản Văn phòng phẩm tăng (Nợ) và tài khoản Phải trả người bán tăng (Có)."
		},
		{
			id: 6,
			...
			options: [
				...
				"Dr Service Revenue $1,000 / Cr Cash $1,000"
			],
			correctAnswer: 2,
			explanation: "Nhận tiền trước khi thực hiện dịch vụ được ghi nhận là Doanh thu chưa thực hiện (Unearned Revenue - một khoản nợ phải trả). Tiền mặt tăng (Nợ), Doanh thu chưa thực hiện tăng (Có)."
		},
		{
			id: 7,
			...
			options: [
				...
				"Dr Depreciation Expense $200 / Cr Equipment $200",
				"Dr Depreciation Expense $200 / Cr Accumulated Depreciation $200"
			],
			correctAnswer: 3,
			explanation: "Khấu hao là chi phí (Nợ). Khoản khấu hao lũy kế (Accumulated Depreciation) làm giảm giá trị tài sản một cách gián tiếp (Có)."
		},
		{
			id: 8,
			...
			options: [
				...
				"Dr Owner's Capital $500 / Cr Cash $500",
				"Dr Salary Expense $500 / Cr Cash $500"
			],
			correctAnswer: 0,
			explanation: "Rút vốn (Drawing) làm giảm vốn chủ sở hữu, ghi Nợ vào tài khoản Rút vốn (Owner's Drawing) và giảm tiền mặt (Cash) ghi Có."
		},
		{
			id: 9,
			...
			options: [
				...
				"Dr Accounts Receivable $1,000 / Cr Cash $1,000",
				"Dr Accounts Payable $1,000 / Cr Revenue $1,000"
			],
			correctAnswer: 0,
			explanation: "Khi trả nợ cho nhà cung cấp, khoản nợ (Accounts Payable) giảm xuống (Nợ) và tiền mặt giảm xuống (Có)."
		},
		{
			id: 10,
			...
			options: [
				...
				"Dr Cash $2,000 / Cr Service Revenue $2,000",
				"Dr Cash $2,000 / Cr Accounts Receivable $2,000"
			],
			correctAnswer: 2,
			explanation: "Khi thực hiện dịch vụ và thu tiền ngay, tiền mặt tăng (Nợ Cash) và doanh thu tăng (Có Service Revenue)."
		}
	];
