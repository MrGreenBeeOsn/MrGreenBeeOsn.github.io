...
import AccountingQuizData from './AccountingQuizData.json';
...
const AccountingQuiz: React.FC = () => {
	...
	const questions: Question[] = useMemo(() => AccountingQuizData as Question[], []);
	...
	return (
		...
		<main className="image image2">
			...
			<article>
				...
				<h4><HashLink smooth to="/accounting#accounting-quiz-01-10"><mark className="highlight-tertiary-padding-4-8">Accounting</mark></HashLink></h4>
