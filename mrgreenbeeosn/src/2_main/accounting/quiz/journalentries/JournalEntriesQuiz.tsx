...
export default function JournalEntriesQuiz(): React.JSX.Element {
	...
	const questions: Question[] = [
		{
			...
			correctAnswer: 0,
			explanation: "When a company provides services and receives cash, the asset (Cash) increases (debit) and the revenue (Service Revenue) increases (credit)."
		},
		{
			id: 2,
			...
			correctAnswer: 1,
			explanation: "Purchasing supplies on account means you receive the asset (Supplies) but have not paid yet, creating a liability (Accounts Payable). Assets increase with a debit and liabilities increase with a credit."
		},
		{
			id: 3,
			...
			correctAnswer: 2,
			explanation: "When cash is received before the service is performed, it is a liability. You debit Cash (asset) and credit Unearned Revenue (liability) because you owe the service to the customer."
		},
		{
			id: 4,
			...
			options: [
				...
				"Debit Owner's Drawings $1,000; Credit Cash $1,000"
			],
			correctAnswer: 3,
			explanation: "Owner's drawings represent a reduction in equity. Drawings are debited (to increase the drawing account) and Cash is credited (to decrease the asset)."
		},
		{
			id: 5,
			...
			options: [
				...
				"Debit Prepaid Insurance $1,200; Credit Accounts Payable $1,200",
				"Debit Cash $1,200; Credit Prepaid Insurance $1,200"
			],
			correctAnswer: 1,
			explanation: "Paying for an expense in advance creates an asset (Prepaid Insurance). You debit the asset and credit Cash to show the outflow."
		},
		{
			id: 6,
			...
			options: [
				...
				"Debit Service Revenue $4,000; Credit Accounts Receivable $4,000",
				"Debit Accounts Payable $4,000; Credit Service Revenue $4,000"
			],
			correctAnswer: 0,
			explanation: "Providing services \"on credit\" means the customer owes the company money. This is an asset (Accounts Receivable) which is debited, and revenue is recorded as a credit."
		},
		{
			id: 7,
			...
			options: [
				...
				"Debit Expenses $800; Credit Cash $800",
				"Debit Accounts Payable $800; Credit Accounts Receivable $800"
			],
			correctAnswer: 0,
			explanation: "Paying a liability decreases the liability (Accounts Payable) and decreases the asset (Cash). A decrease in a liability is recorded as a debit."
		},
		{
			id: 8,
			...
			options: [
				...
				"Debit Depreciation Expense $500; Credit Equipment $500"
			],
			correctAnswer: 2,
			explanation: "Depreciation is an expense. We debit Depreciation Expense to increase it, and credit Accumulated Depreciation (a contra-asset account) to track the loss in value of the equipment over time."
		},
		{
			id: 9,
			...
			options: [
				...
				"Debit Equipment $15,000, Debit Notes Payable $5,000; Credit Cash $20,000",
				"Debit Cash $5,000, Debit Notes Payable $15,000; Credit Equipment $20,000"
			],
			correctAnswer: 0,
			explanation: "Assets are recorded at their full value (debit Equipment $20k). You credit the cash paid ($5k) and credit the new liability (Notes Payable $15k)."
		},
		{
			id: 10,
			...
			options: [
				...
				"Debit Accounts Payable $600; Credit Utilities Expense $600",
				"Debit Cash $600; Credit Utilities Expense $600"
			],
			correctAnswer: 1,
			explanation: "When an expense is incurred but has not yet been paid, you recognize the expense (Debit) and create a liability (Credit) because you owe the money. Accounts Payable is used to record this obligation."
		}
	];
	...
	return (
		...
		<main className="image image2">
			...
			<article>
				...
				<h4><HashLink smooth to="/accounting#journal-entries-quiz"><mark className="highlight-tertiary-padding-4-8">Quiz</mark></HashLink></h4>
	
				<header className="quiz-header">
					<h1 className="margin-y-50 text-center">Accounting Journal Entries Practice</h1>
