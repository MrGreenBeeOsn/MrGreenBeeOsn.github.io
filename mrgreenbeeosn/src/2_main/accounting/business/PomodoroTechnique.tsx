...
export default function PomodoroTechnique(): React.JSX.Element {

  const postId = "PomodoroTechnique";
  ...
  <main className="image image2">
    ...
    <article>
      ...
      <h1 className="margin-y-50 text-center">What is Pomodoro Technique?</h1>
