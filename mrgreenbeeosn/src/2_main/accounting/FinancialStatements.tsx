...
export default function FinancialStatements(): React.JSX.Element {

  const postId = "FinancialStatements";
  ...
  <main className="image image2">
    ...
    <article>
      ...
      <h1 className="margin-y-50 text-center">What are Financial Statements?</h1>
